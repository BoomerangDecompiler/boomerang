...
<a href="#warning">Warning: what Boomerang can't do</a><br>
<a href="FAQ.html">FAQ</a><br>
<a href="students.html">Information for students</a><br>
<h2><a name="News"></a>News</h2>
<b>24/Nov/03: </b>The main authors of Boomerang have been using it for
some consulting work. The clients already had some source code, but for
an earlier version of their product. (If this was not the case,
Boomerang would certainly not be ready for such real-world code). As a
result, Boomerang has had many improvements. Booked in Makefile for the
qtgui (see <a href="#making">Making Boomerang</a> for more details).<b><br>
<br>
1 Oct 03: </b>We now use and require the Boehm garbage collector.
Over time, we will remove code for freeing objects.<br>
<br>
...
<ul>
  <li><b>gcc version 3.1 or later</b> (3.0 might work; 2.96 has a
chance).
...
page</a>.<br>
    ...
    <li>QT toolkit to make the QT version of the GUI. (This is in the <span
 style="font-family: monospace;">qtgui/</span> directory; there is
still an old gui in the <span style="font-family: monospace;">gui/</span>
directory). Set the environment variable QTDIR to point to the
installation. To make, cd to qtgui and <span
 style="font-family: monospace;">make</span>.&nbsp; To run the gui,
ensure that you have <span style="font-family: monospace;">$QTGUI/lib</span>
in your <span style="font-family: monospace;">LD_LIBRARY_PATH</span>.
You need an X server, obviously. This GUI is in very early stages, and
basically only displays the XML files generated by the -x option. </li>
  </ul>
</blockquote>
<font color="#999999"></font>
    
<h2><a name="warning"></a>Warning: what Boomerang can't do</h2>
<p>In case you want to try Boomerang as it is as a decompiler
(as opposed to experimenting with it, or improving it), be aware of
its severe limitations. As of late 2003, Boomerang will only decompile
X86 (Linux/X86 or Windows PE) and SPARC (Solaris, or presumably Linux/SPARC).
In particular, note that it will not handle DOS or NE (Windows 3.1) programs.
Adding another processor is a large (several month) undertaking.</p>

<p>
It will only generate C, not C++. It will decompile C++ programs of course,
(and any sorts of programs, including assembler). You may be able to hand
alter some C++ programs into usable C++ source code. For MSVC compiled
programs, at present you have to spoonfeed the decompiler and tell it that
there is one register parameter (thiscall calling convention). The switches
to handle this are not documented, so email the authors if you are desperate
...
<div align="left"><small>Last modified: 02/12/03: Warning section</small><br>
</div>
</div>
<br>
<br>
...
<br>
<br>
<a target="_top" href="http://t.extreme-dm.com/?login=quantumg">
<img src="http://t1.extreme-dm.com/i.gif" height="38" border="0"
 width="41" alt=""></a>
...
"/c.g?tag=quantumg&j=y&srw="+EXw+"&srb="+EXb+"&",
"l="+escape(EXd.referrer)+"\" height=1 width=1>");//-->
</script>
<noscript><img height=1 width=1 alt=""
src="http://t0.extreme-dm.com/c.g?tag=quantumg&j=n"></noscript>
</body>
</html>
