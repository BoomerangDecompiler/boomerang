...
RTL *SparcDecoder::createBranchRtl(Address pc, std::list<Instruction *> *stmts, const char *name)
{
    ...
    if (name[0] == 'F') {
        ...
        default:
            LOG_STREAM(LogLevel::Warning) << "unknown float branch " << name << '\n';
            delete res;
            res = nullptr;
        }
    ...
    case 'V':
        ...
        if (name[2] == 'C') {
            LOG_STREAM(LogLevel::Warning) << "Decoded BVC instruction\n"; // BVC
        }
        else {
            LOG_STREAM(LogLevel::Warning) << "Decoded BVS instruction\n"; // BVS
        }
    ...
    default:
        LOG_STREAM(LogLevel::Warning) << "unknown non-float branch " << name << '\n';
    }
...
bool SparcDecoder::decodeInstruction(Address pc, ptrdiff_t delta, DecodeResult& result)
{
    ...
    // #line 212 "frontend/machine/sparc/decoder.m"
    {
        ...
        static const char *MATCH_name_op3_46[] =
        {
            ...
            nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
            nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
            nullptr, nullptr, nullptr, nullptr, nullptr, "RDPSR",
            "RDWIM", "RDTBR",
        };
    ...
    : NJMCDecoder(_prog)
{
    ...
    QString file = Boomerang::get()->getDataDirectory().absoluteFilePath("frontend/machine/sparc/sparc.ssl");
