...
#line 25 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if ((0 <= (MATCH_w_32_0 >> 30 & 0x3)) /* op at 0 */ && ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ < 2) ||
                ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 3) ||
                ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((1 <= (MATCH_w_32_0 >> 19 & 0x3f)) /* op3 at 0 */ &&
...
#line 51 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if (((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 56) &&
                ((0 <= (MATCH_w_32_0 >> 13 & 0x1)) /* i at 0 */ && ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ < 2))) {
...
#line 53 "machine/sparc/sparc.pat.m"
                ...
                if (!dispA(_a, a, a_isVAR, b, b_isVAR)) {
                    return false;
                }
...
#line 75 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if (((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 2) &&
                ((0 <= (MATCH_w_32_0 >> 13 & 0x1)) /* i at 0 */ && ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ < 2))) {
                unsigned _a = (MATCH_w_32_0 >> 14 & 0x1f) /* rs1 at 0 */;
                unsigned _b = addressToPC(MATCH_p);
                unsigned _c = (MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */;
...
#line 114 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if (((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 60) &&
                ((0 <= (MATCH_w_32_0 >> 13 & 0x1)) /* i at 0 */ && ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ < 2))) {
                unsigned _a = (MATCH_w_32_0 >> 14 & 0x1f) /* rs1 at 0 */;
                unsigned _b = addressToPC(MATCH_p);
                unsigned _c = (MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */;
...
#line 140 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if (((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 4) &&
                ((0 <= (MATCH_w_32_0 >> 13 & 0x1)) /* i at 0 */ && ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ < 2))) {
                unsigned _a = (MATCH_w_32_0 >> 14 & 0x1f) /* rs1 at 0 */;
                unsigned _b = addressToPC(MATCH_p);
                unsigned _c = (MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */;
...
#line 153 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if (((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 0) && ((MATCH_w_32_0 >> 22 & 0x7) /* op2 at 0 */ == 0)) {
...
#line 164 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 1) {
                unsigned _a = 4 * sign_extend((MATCH_w_32_0 & 0x3fffffff) /* disp30 at 0 */, 30) + addressToPC(MATCH_p);
                nextPC = 4 + MATCH_p;
...
#line 174 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) {
                unsigned                _a = (MATCH_w_32_0 >> 14 & 0x1f) /* rs1 at 0 */;
                int /* [~4096..4095] */ _b = sign_extend((MATCH_w_32_0 & 0x1fff) /* simm13 at 0 */, 13);
...
#line 184 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) {
                int /* [~4096..4095] */ _a = sign_extend((MATCH_w_32_0 & 0x1fff) /* simm13 at 0 */, 13);
...
#line 193 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if (((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) &&
                ((1 <= (MATCH_w_32_0 & 0x1f)) /* rs2 at 0 */ && ((MATCH_w_32_0 & 0x1f) /* rs2 at 0 */ < 32)) ||
...
#line 203 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if (((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 2) &&
                ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) && ((MATCH_w_32_0 >> 14 & 0x1f) /* rs1 at 0 */ == 0)) {
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if ((0 <= (MATCH_w_32_0 >> 30 & 0x3)) /* op at 0 */ && ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ < 2) ||
                ...
                ((0 <= (MATCH_w_32_0 >> 19 & 0x3f)) /* op3 at 0 */ &&
                 ...
                 ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ < 64)) ||
                ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 61) &&
                ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) && ((MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */ == 0) &&
                ...
                ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 61) &&
                ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) && ((1 <= (MATCH_w_32_0 >> 25 & 0x1f)) /* rd at 0 */ &&
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if ((0 <= (MATCH_w_32_0 >> 30 & 0x3)) /* op at 0 */ && ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ < 2) ||
                ...
                ((0 <= (MATCH_w_32_0 >> 19 & 0x3f)) /* op3 at 0 */ &&
                 ...
                 ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ < 64)) ||
                ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 56) &&
                ((0 <= (MATCH_w_32_0 & 0x1fff)) /* simm13 at 0 */ && ((MATCH_w_32_0 & 0x1fff) /* simm13 at 0 */ < 8) ||
                 (9 <= (MATCH_w_32_0 & 0x1fff)) /* simm13 at 0 */ &&
                 ((MATCH_w_32_0 & 0x1fff) /* simm13 at 0 */ < 8192)) ||
                ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 56) &&
                ((MATCH_w_32_0 & 0x1fff) /* simm13 at 0 */ == 8) && ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) ||
                ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 56) &&
                ((MATCH_w_32_0 & 0x1fff) /* simm13 at 0 */ == 8) && ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) &&
                ((MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */ == 0) &&
                ((0 <= (MATCH_w_32_0 >> 14 & 0x1f)) /* rs1 at 0 */ &&
                 ((MATCH_w_32_0 >> 14 & 0x1f) /* rs1 at 0 */ < 31)) ||
                ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 2) && ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 56) &&
                ((MATCH_w_32_0 & 0x1fff) /* simm13 at 0 */ == 8) && ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) &&
                ((1 <= (MATCH_w_32_0 >> 25 & 0x1f)) /* rd at 0 */ && ((MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */ < 32))) {
...
#line 254 "machine/sparc/sparc.pat.m"
        ...
        unsigned MATCH_w_32_0;
        {
            ...
            if (((MATCH_w_32_0 >> 22 & 0x7) /* op2 at 0 */ == 4) && ((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */ == 0)) {
...
Logue *InstructionPatterns::struct_call(CSR& csr, ADDRESS& lc, int& addr, int& imm22)
{
    ...
    if (call__(lc, addr, VAR) && (lc += 4, true) && UNIMP(lc, imm22, VAR)) {
        vector<int> params(2);
        params[0] = addr;
        params[1] = imm22;
...
Logue *InstructionPatterns::call_rst_ui_reg(CSR& csr, ADDRESS& lc, int& addr, int& imm22, int& rs1, int& rs2, int& rd)
{
    ...
    if (call__(lc, addr, VAR) && RESTORE$rmode(lc, rs1, VAR, rs2, VAR, rd, VAR) && UNIMP(lc, imm22, VAR)) {
        vector<int> params(5);
        params[0] = addr;
        params[1] = imm22;
        params[2] = rs1;
...
Logue *InstructionPatterns::call_rst_ui_imm(CSR& csr, ADDRESS& lc, int& addr, int& imm22, int& rs1, int& imm, int& rd)
{
    ...
    if (call__(lc, addr, VAR) && RESTORE$imode(lc, rs1, VAR, imm, VAR, rd, VAR) && UNIMP(lc, imm22, VAR)) {
        vector<int> params(5);
        params[0] = addr;
        params[1] = imm22;
        params[2] = rs1;
...
Logue *InstructionPatterns::call_restore_reg(CSR& csr, ADDRESS& lc, int& addr, int& rs1, int& rs2, int& rd)
{
    ...
    if (call__(lc, addr, VAR) && RESTORE$rmode(lc, rs1, VAR, rs2, VAR, rd, VAR)) {
        vector<int> params(4);
        params[0] = addr;
        params[1] = rs1;
        params[2] = rs2;
...
Logue *InstructionPatterns::call_restore_imm(CSR& csr, ADDRESS& lc, int& addr, int& rs1, int& imm, int& rd)
{
    ...
    if (call__(lc, addr, VAR) && RESTORE$imode(lc, rs1, VAR, imm, VAR, rd, VAR)) {
        vector<int> params(4);
        params[0] = addr;
        params[1] = rs1;
        params[2] = imm;
...
Logue *InstructionPatterns::move_call_move(CSR& csr, ADDRESS& lc, int& addr, int& rd)
{
    ...
    if (mov_(lc, o7, VAL, rd, VAR) && call__(lc, addr, VAR) && mov_(lc, rd, VAR, o7, VAL)) {
        vector<int> params(2);
        params[0] = addr;
        params[1] = rd;
...
Logue *InstructionPatterns::move_x_call_move(CSR& csr, ADDRESS& lc, int& addr, int& rd)
{
    ...
    if (mov_(lc, o7, VAL, rd, VAR) && (lc += 4, true) && call__(lc, addr, VAR) && mov_(lc, rd, VAR, o7, VAL)) {
        vector<int> params(2);
        params[0] = addr;
        params[1] = rd;
...
Logue *InstructionPatterns::call_add(CSR& csr, ADDRESS& lc, int& addr, int& imm)
{
    ...
    if (call__(lc, addr, VAR) && ADD$imode(lc, o7, VAL, imm, VAR, o7, VAL)) {
        vector<int> params(2);
        params[0] = addr;
        params[1] = imm;
...
Logue *InstructionPatterns::jmp_restore_reg(CSR& csr, ADDRESS& lc, int& rs1j, int& rdj, int& rs1, int& rs2, int& rd)
{
    ...
    if (JMPL$indirectA(lc, rs1j, VAR, rdj, VAR) && RESTORE$rmode(lc, rs1, VAR, rs2, VAR, rd, VAR)) {
        vector<int> params(5);
        params[0] = rs1j;
        params[1] = rdj;
        params[2] = rs1;
...
Logue *InstructionPatterns::jmp_restore_imm(CSR& csr, ADDRESS& lc, int& rs1j, int& rdj, int& rs1, int& imm, int& rd)
{
    ...
    if (JMPL$indirectA(lc, rs1j, VAR, rdj, VAR) && RESTORE$imode(lc, rs1, VAR, imm, VAR, rd, VAR)) {
        vector<int> params(5);
        params[0] = rs1j;
        params[1] = rdj;
        params[2] = rs1;
...
Logue *InstructionPatterns::new_reg_win(CSR& csr, ADDRESS& lc, int& locals)
{
    ...
    if (SAVE$imode(lc, SP, VAL, locals, VAR, SP, VAL)) {
        vector<int> params(1);
        params[0] = locals;
...
Logue *InstructionPatterns::same_reg_win(CSR& csr, ADDRESS& lc, int& locals)
{
    ...
    if (ADD$imode(lc, SP, VAL, locals, VAR, SP, VAL)) {
        vector<int> params(1);
        params[0] = locals;
...
Logue *InstructionPatterns::new_reg_win_large(CSR& csr, ADDRESS& lc, int& hiVal, int& loVal, int& reg)
{
    ...
    if (sethi(lc, hiVal, VAR, reg, VAR) &&
        (ADD$imode(lc, reg, VAR, loVal, VAR, reg, VAR) || OR$imode(lc, reg, VAR, loVal, VAR, reg, VAR)) &&
...
Logue *InstructionPatterns::std_ret(CSR& csr, ADDRESS& lc)
{
    ...
    if ((ret(lc) || JMPL$dispA(lc, i7, VAL, __loc0 = 12, VAL, g0, VAL)) && restore_(lc)) {
        vector<int> params(0);
...
Logue *InstructionPatterns::ret_reg_val(CSR& csr, ADDRESS& lc, int& rs1, int& rs2)
{
    ...
    if ((ret(lc) || JMPL$dispA(lc, i7, VAL, __loc0 = 12, VAL, g0, VAL)) &&
...
Logue *InstructionPatterns::leaf_ret(CSR& csr, ADDRESS& lc)
{
    ...
    if ((retl(lc) || JMPL$dispA(lc, o7, VAL, __loc0 = 12, VAL, g0, VAL)) &&
