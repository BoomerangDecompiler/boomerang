...
private:
    ...
    static bool FSTDS$s_addr_im_r$c_s_addr_ma(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c,
                                              bool c_isVAR, int& d, bool d_isVAR);
    static bool LDO(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c, bool c_isVAR);
    static bool LDW$l_addr_16_old$c_l_addr_none(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c,
                                                bool c_isVAR, int& d, bool d_isVAR);
    static bool LDWM$l_addr_16_old$c_l_addr_none(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c,
                                                 bool c_isVAR, int& d, bool d_isVAR);
    static bool LDWS$s_addr_im_r$c_s_addr_mb(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c,
                                             bool c_isVAR, int& d, bool d_isVAR);
    static bool LDWS$s_addr_im_r$c_s_addr_notm(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c,
                                               bool c_isVAR, int& d, bool d_isVAR);
    static bool OR$c_arith_w$c_c_nonneg(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c, bool c_isVAR,
                                        int& d, bool d_isVAR);
    static bool STW$l_addr_16_old$c_l_addr_none(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c,
                                                bool c_isVAR, int& d, bool d_isVAR);
    static bool STWM$l_addr_16_old$c_l_addr_none(ADDRESS& lc, int& a, bool a_isVAR, int& b, bool b_isVAR, int& c,
                                                 bool c_isVAR, int& d, bool d_isVAR);
