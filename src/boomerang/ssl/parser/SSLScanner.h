...
#                define YY_SSLScanner_ECHO_CODE                                                    \
                    fwrite((char *)YY_SSLScanner_TEXT, YY_SSLScanner_LENG, 1, YY_SSLScanner_OUT);
#            else
#                define YY_SSLScanner_ECHO_CODE                                                    \
                    (YY_SSLScanner_OUT->write((char *)YY_SSLScanner_TEXT, YY_SSLScanner_LENG));
#            endif
#        endif
...
#            ifndef YY_SSLScanner_IOSTREAM
#                define YY_SSLScanner_INPUT_CODE                                                   \
                    return result = fread(buffer, 1, max_size, YY_SSLScanner_IN);
