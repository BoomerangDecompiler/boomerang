...
extern YY_BUFFER_STATE YY_AnsiCScanner_CREATE_BUFFER YY_PROTO((YY_AnsiCScanner_IFILE * file,
                                                               int size));
...
extern YY_AnsiCScanner_LEX_RETURN
YY_AnsiCScanner_LEX(yy_AnsiCParser_stype &yylval) YY_AnsiCScanner_LEX_PARAM_DEF
#        else
#            ifndef YY_DECL
extern YY_AnsiCScanner_LEX_RETURN
YY_AnsiCScanner_LEX(yy_AnsiCParser_stype &yylval) YY_AnsiCScanner_LEX_PARAM_DEF
...
#                define YY_AnsiCScanner_ECHO_CODE                                                  \
                    fwrite((char *)YY_AnsiCScanner_TEXT, YY_AnsiCScanner_LENG, 1,                  \
                           YY_AnsiCScanner_OUT);
#            else
#                define YY_AnsiCScanner_ECHO_CODE                                                  \
                    (YY_AnsiCScanner_OUT->write((char *)YY_AnsiCScanner_TEXT,                      \
                                                YY_AnsiCScanner_LENG));
#            endif
#        endif
