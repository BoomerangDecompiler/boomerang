...
DecodeResult& NJMCDecoder::decodeInstruction(ADDRESS pc, int delta, UserProc *proc = nullptr)
{
	...
	else if ((logue = InstructionPatterns::near_call(csr, hostPC, addr)) != nullptr) {
		/*
	...
	else if ((logue = InstructionPatterns::pea_pea_add_rts(csr, hostPC, d32)) != nullptr) {
		/*
	...
	else if ((logue = InstructionPatterns::pea_add_rts(csr, hostPC, d32)) != nullptr) {
		/*
	...
	else if ((logue = InstructionPatterns::trap_syscall(csr, hostPC, d16)) != nullptr) {
		/*
	 ...
	 * CALLEE PROLOGUES
	 */
	else if ((logue = InstructionPatterns::link_save(csr, hostPC, locals, d16)) != nullptr) {
		/*
	...
	else if ((logue = InstructionPatterns::link_save1(csr, hostPC, locals, reg)) != nullptr) {
		/*
	...
	else if ((logue = InstructionPatterns::push_lea(csr, hostPC, locals, reg)) != nullptr) {
		/*
	...
	else if ((logue = InstructionPatterns::std_link(csr, hostPC, locals)) != nullptr) {
		/*
		 * Standard link
		 */
		if (proc != nullptr) {
	...
	else if ((logue = InstructionPatterns::clear_stack(csr, hostPC, stackSize)) != nullptr) {
		/*
...
MATCH_label_de0:
			(void)0; /*placeholder for label*/
			{
				...
				result.rtl = new RTlist(pc, decodeLowLevelInstruction(hostPC, pc, result));
			}
			goto MATCH_finished_de;
...

	{
		...
		unsigned /* [0..65535] */ MATCH_w_16_16;
		{
			...
			if ((MATCH_w_16_0 & 0xff) /* data8 at 0 */ == 0) {
				...
				{
					int /* [~32768..32767] */ dsp16 = sign_extend((MATCH_w_16_16 & 0xffff) /* d16 at 16 */, 16);
...
SemStr *NJMCDecoder::alEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::amEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::awlEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::dEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::daEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::dBEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::dWEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::maEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::msEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::mdEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::mrEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
...
SemStr *NJMCDecoder::rmEA(ADDRESS ea, ADDRESS pc, int& bump, int& bumpr, int size)
{
	SemStr *ret = new SemStr(size);
	...
	case 0:

		{
			...
			unsigned /* [0..65535] */ MATCH_w_16_0;
			{
				MATCH_w_16_0 = getWord(MATCH_p);
				{
					int /* [~32768..32767] */ d16 = sign_extend((MATCH_w_16_0 & 0xffff) /* d16 at 0 */, 16);
	...
	case 5:

		{
			...
			unsigned /* [0..65535] */ MATCH_w_16_16;
			{
				...
				{
					unsigned d32 =
						((MATCH_w_16_0 & 0xffff) /* d16 at 0 */ << 16) + (MATCH_w_16_16 & 0xffff) /* d16 at 16 */;
	...
	case 2:

		{
			...
			unsigned /* [0..65535] */ MATCH_w_16_0;
			{
				MATCH_w_16_0 = getWord(MATCH_p);
				{
					unsigned d16 = sign_extend((MATCH_w_16_0 & 0xffff) /* d16 at 0 */, 16) + addressToPC(MATCH_p);
...

		{
			...
			unsigned /* [0..65535] */ MATCH_w_16_0;
			{
				...
				if (((MATCH_w_16_0 >> 12 & 0x7) /* iReg at 0 */ == 0) &&
					...
					(1 <= (MATCH_w_16_0 >> 12 & 0x7)) /* iReg at 0 */ && ((MATCH_w_16_0 >> 12 & 0x7) /* iReg at 0 */ < 8)) {
	...
	case 2:

		{
			...
			unsigned /* [0..65535] */ MATCH_w_16_0;
			{
				MATCH_w_16_0 = getWord(MATCH_p);
				{
					unsigned label = sign_extend((MATCH_w_16_0 & 0xffff) /* d16 at 0 */, 16) + addressToPC(MATCH_p);
...

	{
		...
		unsigned /* [0..65535] */ MATCH_w_16_0;
		{
			...
			case 4:
				...
				if (((MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 2) && ((MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 7)) {
					mode             = 8;
					result.numBytes += 4;
				}
...
bool isFuncPrologue(ADDRESS hostPC)
{
	...
	if ((InstructionPatterns::link_save(prog.csrSrc, hostPC, locals, d16)) != nullptr) {
		return true;
	}

	if ((InstructionPatterns::link_save1(prog.csrSrc, hostPC, locals, reg)) != nullptr) {
		return true;
	}

	if ((InstructionPatterns::push_lea(prog.csrSrc, hostPC, locals, reg)) != nullptr) {
		return true;
	}
