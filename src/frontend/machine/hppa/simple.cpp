...
#line 23 "machine/hppa/simple.m"
		...
		unsigned MATCH_w_32_0;
		{
			...
			if ((MATCH_w_32_0 >> 9 & 0x1) /* addr_22 at 0 */ == 1) {
				...
				unsigned d = (sign_extend((MATCH_w_32_0 >> 16 & 0x1) /* im1_15 at 0 */, 1) << 4) +
...
#line 79 "machine/hppa/simple.m"
		...
		unsigned MATCH_w_32_0;
		{
			...
			if ((0 <= (MATCH_w_32_0 >> 26 & 0x3f)) /* op at 0 */ && ((MATCH_w_32_0 >> 26 & 0x3f) /* op at 0 */ < 12) ||
				(13 <= (MATCH_w_32_0 >> 26 & 0x3f)) /* op at 0 */ && ((MATCH_w_32_0 >> 26 & 0x3f) /* op at 0 */ < 64) ||
				((MATCH_w_32_0 >> 26 & 0x3f) /* op at 0 */ == 12) &&
				((0 <= (MATCH_w_32_0 >> 9 & 0x3)) /* class_21 at 0 */ &&
				 ((MATCH_w_32_0 >> 9 & 0x3) /* class_21 at 0 */ < 3)) ||
				((MATCH_w_32_0 >> 26 & 0x3f) /* op at 0 */ == 12) && ((MATCH_w_32_0 >> 9 & 0x3) /* class_21 at 0 */ == 3) &&
