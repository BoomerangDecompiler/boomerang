...
#line 105 "machine/sparc/disassembler.m"
		...
		static char *MATCH_name_op3_44[] =
		{
			...
			(char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0,
			(char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0, (char *)0,
			(char *)0, (char *)0, (char *)0, (char *)0, (char *)0, "RDPSR",   "RDWIM",   "RDTBR",
		};
		...
		static char *MATCH_name_i_62[] =
		{
			"LDUB", "LD",
		};
		static char *MATCH_name_i_63[] =
		{
			"LDUH", "LDUB",
		};
		static char *MATCH_name_i_64[] =
		{
			"LDD", "LDUH",
		};
		static char *MATCH_name_i_65[] =
		{
			"ST", "LDD",
		};
		static char *MATCH_name_i_66[] =
		{
			"STB", "ST",
		};
		static char *MATCH_name_i_67[] =
		{
			"STH", "STB",
		};
		static char *MATCH_name_i_68[] =
		{
			"STD", "STH",
		};
		static char *MATCH_name_i_69[] =
		{
			"LDSB", "STD",
		};
		static char *MATCH_name_i_70[] =
		{
			"LDSH", "LDSB",
		};
		static char *MATCH_name_i_71[] =
		{
			"LDSTUB", "LDSH",
		};
		static char *MATCH_name_i_72[] =
		{
			"SWAP.", "LDSTUB",
		};
		static char *MATCH_name_i_73[] =
		{
			"LDA", "SWAP.",
		};
		static char *MATCH_name_i_74[] =
		{
			"LDUBA", "LDF",
		};
		static char *MATCH_name_i_75[] =
		{
			"LDUHA", "LDFSR",
		};
		static char *MATCH_name_i_76[] =
		{
			"LDDA", "LDDF",
		};
		static char *MATCH_name_i_77[] =
		{
			"STA", "STF",
		};
		static char *MATCH_name_i_78[] =
		{
			"STBA", "STFSR",
		};
		static char *MATCH_name_i_79[] =
		{
			"STHA", "STDFQ",
		};
		static char *MATCH_name_i_80[] =
		{
			"STDA", "STDF",
		};
		static char *MATCH_name_i_81[] =
		{
			"LDSBA", "LDC",
		};
		static char *MATCH_name_i_82[] =
		{
			"LDSHA", "LDCSR",
		};
		static char *MATCH_name_i_83[] =
		{
			"LDSTUBA", "LDDC",
		};
		static char *MATCH_name_i_84[] =
		{
			"SWAPA", "STC",
		};
		static char *MATCH_name_i_85[] =
		{
			"LDF", "STCSR",
		};
		static char *MATCH_name_i_86[] =
		{
			"LDFSR", "STDCQ",
		};
		static char *MATCH_name_i_87[] =
		{
			"LDDF", "STDC",
		};
		unsigned MATCH_w_32_0;
...
#line 108 "machine/sparc/disassembler.m"
			...
			case 1:
				{
					unsigned tgt =
						4 * sign_extend((MATCH_w_32_0 & 0x3fffffff) /* disp30 at 0 */, 30) + addressToPC(MATCH_p);
					nextPC = 4 + MATCH_p;
...
#line 195 "machine/sparc/disassembler.m"
				...
				case 52:
					...
					if ((80 <= (MATCH_w_32_0 >> 5 & 0x1ff)) /* opf at 0 */ &&
						...
						case 9:
						case 41:
							MATCH_name = MATCH_name_opf_49[(MATCH_w_32_0 >> 5 & 0x1ff)
							                               /* opf at 0 */];
							{
								char     *name = MATCH_name;
...
#line 236 "machine/sparc/disassembler.m"
				...
				case 56:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) {
						...
						{
						case 0:
							MATCH_name = MATCH_name_rs1_51[(MATCH_w_32_0 >> 14 & 0x1f)
							                               /* rs1 at 0 */];
							goto MATCH_label_a5;
...
#line 117 "machine/sparc/disassembler.m"
						...
						MATCH_name = MATCH_name_i_50[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
						goto MATCH_label_a5;
					} /*opt-block*/
				...
				case 57:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) {
						MATCH_name = MATCH_name_i_54[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
						goto MATCH_label_a6;
					} /*opt-block*/
					else {
						MATCH_name = MATCH_name_i_50[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
...
#line 123 "machine/sparc/disassembler.m"
				...
				case 61:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) {
						MATCH_name = MATCH_name_i_61[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
						goto MATCH_label_a4;
					} /*opt-block*/
					else if (((MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */ == 0) &&
...
#line 114 "machine/sparc/disassembler.m"
			...
			case 3:
				...
				case 0:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) {
						MATCH_name = MATCH_name_i_62[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
						goto MATCH_label_a7;
					} /*opt-block*/
					else {
						MATCH_name = MATCH_name_i_61[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
				...
				case 1:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) {
						MATCH_name = MATCH_name_i_63[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
						goto MATCH_label_a7;
					} /*opt-block*/
					else {
						MATCH_name = MATCH_name_i_62[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
				...
				case 2:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) {
						MATCH_name = MATCH_name_i_64[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
						goto MATCH_label_a7;
					} /*opt-block*/
					else {
						MATCH_name = MATCH_name_i_63[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
				...
				case 3:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) {
						MATCH_name = MATCH_name_i_65[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
						goto MATCH_label_a7;
					} /*opt-block*/
					else {
						MATCH_name = MATCH_name_i_64[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
				...
				case 32:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) {
						MATCH_name = MATCH_name_i_85[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
				...
				case 33:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) {
						MATCH_name = MATCH_name_i_86[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
				...
				case 35:
					...
					if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 0) {
						MATCH_name = MATCH_name_i_87[(MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */];
...
MATCH_label_a1:
		...
		{
			char     *name = MATCH_name;
			unsigned tgt   = 4 * sign_extend((MATCH_w_32_0 & 0x3fffff) /* disp22 at 0 */, 22) + addressToPC(MATCH_p);
			nextPC = 4 + MATCH_p;
