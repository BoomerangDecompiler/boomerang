...
void not_used(int unwanted) { unwanted = 0; }
...
SemStr *NJMCDecoder::c_c(ADDRESS hostpc, int &cond) {
    static const char *c_c_names[] = {"c_c_no",  "c_c_eq", "c_c_l",   "c_c_le", "c_c_ul", "c_c_ule",
                                      "c_c_sv",  "c_c_od", "c_c_yes", "c_c_ne", "c_c_ge", "c_c_g",
                                      "c_c_uge", "c_c_ug", "c_c_nsv", "c_c_ev"};
...
#line 170 "machine/hppa/decoder_low.m"
        ...
        static char *MATCH_name_sub_16_73[] = {
            "FCMP", "FSUB", "FMPY", "FDIV",
        };
        static char *MATCH_name_sub_16_74[] = {
            "FADD", "FTEST.E",
        };
        static char *MATCH_name_sub_14_75[] = {
            "FCNVFF.E", "FCNVXF.E", "FCNVFX.E", "FCNVFXT.E",
        };
        static char *MATCH_name_p_20_88[] = {
            "VSHD", "SHD",
        };
        static char *MATCH_name_se_21_89[] = {
            "VEXTRU", "VEXTRS",
        };
        static char *MATCH_name_se_21_90[] = {
            "EXTRU", "EXTRS",
        };
        static char *MATCH_name_se_21_91[] = {
            "ZVDEP", "VDEP",
        };
        static char *MATCH_name_se_21_92[] = {
            "ZDEP", "DEP",
        };
        static char *MATCH_name_se_21_93[] = {
            "ZVDEPI", "VDEPI",
        };
        static char *MATCH_name_se_21_94[] = {
            "ZDEPI", "DEPI",
        };
        unsigned MATCH_w_32_0;
        {
...
#line 281 "machine/hppa/decoder_low.m"
                    ...
                    case 32:
                        if ((MATCH_w_32_0 >> 16 & 0x1f) /* ext5_11 at 0 */ == 0 ||
                            ...
                            MATCH_name = MATCH_name_ext5_11_1[(MATCH_w_32_0 >> 16 & 0x1f)
                                                              /* ext5_11 at 0 */];
                            goto MATCH_label_a1;
...
#line 308 "machine/hppa/decoder_low.m"
                            {
                                ...
                                RTs =
                                    instantiate(pc, name, dis_Num(sf), dis_Num(df), dis_Freg(rf, sf), dis_Freg(tf, df));
                            }
                        }
                ...
                case 2:
                    ...
                    case 0:
                        MATCH_name = MATCH_name_sub_16_73[(MATCH_w_32_0 >> 13 & 0x7)
                                                          /* sub_16 at 0 */];
                        goto MATCH_label_a9;
                ...
                case 3:
                    ...
                    switch ((MATCH_w_32_0 >> 13 & 0x7) /* sub_16 at 0 */) {
                    case 0:
                        MATCH_name = MATCH_name_sub_16_74[(MATCH_w_32_0 >> 13 & 0x7)
                                                          /* sub_16 at 0 */];
                ...
                case 3:
                    ...
                    case 2:
                        if ((MATCH_w_32_0 >> 8 & 0x1) /* x_23 at 0 */ == 1) {
                            unsigned fr1 = ((MATCH_w_32_0 >> 7 & 0x1) /* r1_24 at 0 */ << 5) +
                                           (MATCH_w_32_0 >> 21 & 0x1f) /* r_06 at 0 */;
                            unsigned fr2 = ((MATCH_w_32_0 >> 12 & 0x1) /* f_19 at 0 */ << 5) +
                                           (MATCH_w_32_0 >> 16 & 0x1f) /* r_11 at 0 */;
                            unsigned frt = ((MATCH_w_32_0 >> 6 & 0x1) /* t_25 at 0 */ << 5) +
                                           (MATCH_w_32_0 & 0x1f) /* t_27 at 0 */;
                            nextPC = 4 + MATCH_p;
...
#line 213 "machine/hppa/decoder_low.m"
                    {
                        ...
                        RTs = instantiate(pc, name, dis_c_addr(c_addr), dis_xd(xd), dis_Sreg(s), dis_Reg(b),
                                          dis_Reg(r_11));
                    }
                }
...
#line 217 "machine/hppa/decoder_low.m"
                    {
                        ...
                        RTs = instantiate(pc, name, dis_c_addr(c_addr), dis_Reg(r_11), dis_xd(xd), dis_Sreg(s),
                                          dis_Reg(b));
                    }
                }
...
#line 236 "machine/hppa/decoder_low.m"
                            {
                                ...
                                RTs = instantiate(pc, name, dis_Reg(r), dis_Num(p), dis_Num(len), dis_Reg(t),
                                                  c_c(c, condvalue));
                            }
                        }
...
#line 228 "machine/hppa/decoder_low.m"
                        {
                            ...
                            RTs = instantiate(pc, name, dis_Reg(r1), dis_Reg(r2), dis_Num(p), dis_Reg(t),
                                              c_c(c, condvalue));
                        }
                    }
...
#line 252 "machine/hppa/decoder_low.m"
                            {
                                ...
                                RTs = instantiate(pc, name, dis_Num(i), dis_Num(p), dis_Num(len), dis_Reg(t),
                                                  c_c(c, condvalue));
                            }
                        }
                ...
                case 5:
                    MATCH_name = "BL.LONG";
                    {
                        ...
                        unsigned ubr_target = 8 + ((MATCH_w_32_0 >> 3 & 0x3ff) /* w10_19 at 0 */ << 2) +
                                              ...
                                              (sign_extend((MATCH_w_32_0 & 0x1) /* w_31 at 0 */, 1) << 23);
                        nextPC = 4 + MATCH_p;
...
#line 331 "machine/hppa/decoder_low.m"
            {
                ...
                cout << "Undecoded instruction " << hex << *(int *)hostPC << " at " << pc << " (opcode "
                     << ((*(unsigned *)hostPC) >> 26) << ")\n";
            }
        }
        goto MATCH_finished_a;
...
#line 193 "machine/hppa/decoder_low.m"
    ...
    MATCH_label_a5:
        (void)0; /*placeholder for label*/
        {
            ...
            unsigned c_addr = addressToPC(MATCH_p);
            unsigned s = (MATCH_w_32_0 >> 14 & 0x3) /* s2_16 at 0 */;
            unsigned t_27 = ((MATCH_w_32_0 >> 6 & 0x1) /* t_25 at 0 */ << 5) + (MATCH_w_32_0 & 0x1f) /* t_27 at 0 */;
            unsigned xd = addressToPC(MATCH_p);
            nextPC = 4 + MATCH_p;
...
#line 312 "machine/hppa/decoder_low.m"
    ...
    MATCH_label_a12:
        (void)0; /*placeholder for label*/
        {
            ...
            unsigned fr2 =
                ((MATCH_w_32_0 >> 12 & 0x1) /* f_19 at 0 */ << 5) + (MATCH_w_32_0 >> 16 & 0x1f) /* r_11 at 0 */;
            unsigned frt = ((MATCH_w_32_0 >> 6 & 0x1) /* t_25 at 0 */ << 5) + (MATCH_w_32_0 & 0x1f) /* t_27 at 0 */;
            nextPC = 4 + MATCH_p;
...
/*
        ...
        | LDWl(cmplt, ldisp, s2_16, b_06, t_11)[name] => {
            ...
            c_disps(cmplt);
            *garble += sprintf(*garble, "  %d(%s,%s),%s", ldisp, s2_16_names[s2_16], b_06_names[b_06],
   t_11_names[t_11]);
