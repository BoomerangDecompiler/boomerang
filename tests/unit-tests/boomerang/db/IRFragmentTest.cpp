...
void IRFragmentTest::testIncomplete()
{
    BasicBlock bb1(Address(0x1000), nullptr);
...
void IRFragmentTest::testGetPredecessor()
{
...
void IRFragmentTest::testGetSuccessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
...
void IRFragmentTest::testSetPredecessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
    BasicBlock pred1(Address::ZERO, nullptr);
...
void IRFragmentTest::testSetSuccessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
    BasicBlock succ1(Address::ZERO, nullptr);
...
void IRFragmentTest::testAddPredecessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
    BasicBlock pred1(Address::ZERO, nullptr);
...
void IRFragmentTest::testAddSuccessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
    BasicBlock succ1(Address::ZERO, nullptr);
...
void IRFragmentTest::testRemovePredecessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
...
void IRFragmentTest::testRemoveSuccessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
...
void IRFragmentTest::testIsPredecessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
...
void IRFragmentTest::testIsSuccessor()
{
    BasicBlock bb1(Address::ZERO, nullptr);
    BasicBlock bb2(Address::ZERO, nullptr);
...
void IRFragmentTest::testCompleteBB()
{
    {
        BasicBlock bb1(Address(0x1000), nullptr);
        QVERIFY(bb1.isIncomplete());
...
void IRFragmentTest::testUpdateBBAddresses()
{
    BasicBlock bb1(Address(0x1000), nullptr);
