...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    unsigned int esp_33; 		// r28{0}
    unsigned int esp_34; 		// r28{0}
    ...
    (*0x45de)(ebx, ebp, hInstance, 0x45de, hInstance, hPrevInstance, lpCmdLine, nCmdShow, esi, edi, 100, 0x4054f4, 103, hInstance, pc, SUBFLAGS32(esp_33, 28, (esp_33 - 28)), esp_33 == 28, esp_33 < 28);
    ...
    *(__size32*)(esp_8 - 8) = esi;
    eax_1 = proc_0x00401150(*(esp_8 - 8)); /* Warning: also results in esp_10, esi */
    local170 = eax_1;
    if (eax_1 != 0) {
        *(__size32*)(esp_10 + 8) = 109;
        *(__size32*)(esp_10 + 4) = esi;
        eax = LoadAcceleratorsA(*(esp_10 + 4), *(esp_10 + 8)); /* Warning: also results in edx */
        *(__size32*)(esp_10 + 12LL - 4) = 0;
        *(__size32*)(esp_10 + 12LL - 8) = 0;
        *(__size32*)(esp_10 + 12LL - 12) = 0;
...
__size32 proc_0x004010c0(__size32 param1)
{
    ...
    (*0x460e)(pc, param1, 107, esi, 48, 3, 0x4011b0, 0, 0, param1, param1, param1, 0x460e, SUBFLAGS32(esp_4, 48, esp_4 - 48), esp_4 == 48, esp_4 < 48);
