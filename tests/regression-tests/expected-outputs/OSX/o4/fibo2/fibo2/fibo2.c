...
int main(int argc, char *argv[])
{
    ...
    if (local0 <= 1) {
        ...
        g3 = fib1(f28, local0 - 1, g29); /* Warning: also results in g30, f28 */
        fib1(f28, g30 - 2, g3);
    }
    printf(/* machine specific */ (int) LR + 916);
    return 0;
}
...
__size32 fib1(__size32 param1, __size32 param1, int param2, __size32 param3)
{
    ...
    local7 = g30_1;
    if (param2 > 1) {
        g3 = fib1(f28, param2 - 1, param3); /* Warning: also results in g30_2 */
        g3 = fib1(param1, g30_2 - 2, g3); /* Warning: also results in g29_2, g30_3 */
        local6 = g29_2;
        local7 = g30_3;
        g3 = g29_2 + g3;
        local5 = g3;
