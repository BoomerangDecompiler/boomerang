...
int passem(__size32 param1, __size32 param2, __size32 param3, __size32 param4, union { __size32 *; __size32; } param5, __size32 param6);
int addem(__size32 param1, __size32 param2, __size32 param3, __size32 param4, union { __size32; __size32 *; } param5);

/** address: 0x00001d44 */
int main(int argc, char *argv[])
{
    union { __size32; __size32 *; } g1; 		// r1
    __size32 g31; 		// r31
