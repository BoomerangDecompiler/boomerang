...
#line 31 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 13 ||
                14 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16 ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 13 &&
                    (0 <= (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ < 4 ||
                     5 <= (MATCH_w_16_0 & 0x7)
                             /* reg2 at 0 */ &&
                         (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ < 8) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 13 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 4 &&
                    (0 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 7) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 13 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 4 &&
                    (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 7 &&
                    (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 7) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 13 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 4 &&
                    (MATCH_w_16_0 >> 3 & 0x7)
                        /* adrm at 0 */ == 7 &&
                    (MATCH_w_16_0 >> 9 & 0x7)
                    ...
                    (MATCH_w_16_0 >> 8 & 0x1)
                        /* sb at 0 */ == 0 &&
                    (0 <= (MATCH_w_16_0 >> 6 & 0x3)
                         /* sz at 0 */ &&
                     (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ < 3) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 13 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 4 &&
                    (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 7 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7 &&
                    (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 1)
                goto MATCH_label_q0; /*opt-block+*/
            else {
                MATCH_w_16_16 = getWord(2 + MATCH_p);
                {
                    int /* [~32768..32767] */ _a = sign_extend((MATCH_w_16_16 & 0xffff) /* d16 at 16 */, 16);
                    nextPC = 4 + MATCH_p;
...
#line 42 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 3 ||
                4 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 8 ||
                (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 3 &&
                    (0 <= (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ < 2 ||
                     (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 3) ||
                (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 3 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 2 &&
                    ((MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 0 ||
                     2 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 5) &&
                    (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 0 && (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 1 ||
                (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 3 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 2 &&
                    ((MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 0 ||
                     2 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 5) &&
                    (1 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16) ||
                (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 3 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 2 &&
                    ((MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 1 ||
                     5 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 8))
                ...
                {
                    unsigned _a =
                        ((MATCH_w_16_16 & 0xffff) /* d16 at 16 */ << 16) + (MATCH_w_16_32 & 0xffff) /* d16 at 32 */;
...
#line 54 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if ((MATCH_w_16_0 >> 8 & 0xf) /* cond at 0 */ == 1 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 6) {
...
#line 65 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 4 ||
                5 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16 ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (0 <= (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ < 2 ||
                     3 <= (MATCH_w_16_0 & 0x7)
                             /* reg2 at 0 */ &&
                         (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ < 8) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    ...
                    (0 <= (MATCH_w_16_0 >> 6 & 0x3)
                     ...
                     (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 3) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 2 &&
                    (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 2 &&
                    (0 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 7) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 2 &&
                    (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 2 && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 7 &&
                    (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 7) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 2 &&
                    (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 2 && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 7 &&
                    (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7 && (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 1)
                goto MATCH_label_n0; /*opt-block+*/
            else {
                MATCH_w_16_16 = getWord(2 + MATCH_p);
                {
                    unsigned _a = 2 + sign_extend((MATCH_w_16_16 & 0xffff) /* d16 at 16 */, 16) + addressToPC(MATCH_p);
                    nextPC = 4 + MATCH_p;
...
#line 103 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if (0 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 5 ||
                6 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 8 ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 5 &&
                    (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 4 ||
                     5 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 5 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 7) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 5 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7 &&
                    (0 <= (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ < 7) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 5 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 7 &&
...
#line 114 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if (0 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 2 ||
                3 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 8 ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 2 &&
                    (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 4 ||
                     5 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 2 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    ((MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 0 ||
                     2 <= (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ < 4) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 2 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
                    (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 7) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 2 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7 &&
                    (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 1)
                ...
                {
                    unsigned _a = (MATCH_w_16_0 & 0x7) /* reg2 at 0 */;
                    int /* [~32768..32767] */ _b = sign_extend((MATCH_w_16_16 & 0xffff) /* d16 at 16 */, 16);
                    nextPC = 4 + MATCH_p;
...
#line 126 "machine/mc68k/mc68k.pat.m"
        ...
        unsigned /* [0..65535] */ MATCH_w_16_16;
        {
            ...
            if (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 4 ||
                5 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16 ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 6 ||
                     (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 6 &&
                    (0 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 2 ||
                     4 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 8) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 6 &&
                    (2 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 4) &&
                    (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 0 &&
                    (0 <= (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ < 3) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 6 &&
                    (2 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 4) &&
                    (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 1)
...
#line 138 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if (((MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 2 || (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 4) &&
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 4 &&
                (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 0 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 3) {
                MATCH_w_16_16 = getWord(2 + MATCH_p);
                {
...
#line 150 "machine/mc68k/mc68k.pat.m"
        ...
        unsigned /* [0..65535] */ MATCH_w_16_16;
        {
            ...
            if (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 4 ||
                5 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16 ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 4 ||
                     5 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 8) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 4 &&
                    (0 <= (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ < 2 ||
                     3 <= (MATCH_w_16_0 & 0x7)
                             /* reg2 at 0 */ &&
                ...
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 4 &&
                    (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 2 && ((MATCH_w_16_0 >> 6 & 0x3)
                                                                      /* sz at 0 */ == 0 ||
                                                                  2 <= (MATCH_w_16_0 >> 6 & 0x3)
                                                                          /* sz at 0 */ &&
                                                                      (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ < 4) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 4 &&
                    (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 2 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
                    (0 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 7) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 4 &&
                    (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 2 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
                    (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 7 && (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 1)
...
#line 161 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if ((MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 3 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 2 &&
                (MATCH_w_16_0 >> 6 & 0x7) /* MDadrm at 0 */ == 0 && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 7) {
                unsigned _a = (MATCH_w_16_0 & 0x7) /* reg2 at 0 */;
                nextPC = 2 + MATCH_p;
...
#line 172 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if ((MATCH_w_16_0 >> 6 & 0x7) /* MDadrm at 0 */ == 4 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 2 &&
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 0 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7) {
                unsigned _a = (MATCH_w_16_0 & 0x7) /* reg2 at 0 */;
                nextPC = 2 + MATCH_p;
...
#line 183 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if (0 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 6 ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 7 ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 6 &&
                    (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 4 ||
                     5 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 6 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (0 <= (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ && (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ < 5 ||
                     6 <= (MATCH_w_16_0 & 0x7)
                             /* reg2 at 0 */ &&
                         (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ < 8) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 6 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 5 && ((MATCH_w_16_0 >> 6 & 0x3)
                                                                  ...
                                                                  2 <= (MATCH_w_16_0 >> 6 & 0x3)
                                                                      ...
                                                                      (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ < 4) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 6 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 5 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
                    (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 7) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 6 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (MATCH_w_16_0 & 0x7) /* reg2 at 0 */ == 5 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
                    (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7 && (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 1)
        ...
        unsigned /* [0..65535] */ MATCH_w_16_0;
        {
            ...
            if (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 4 ||
                ...
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    ((MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 0 ||
                     2 <= (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ < 4) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
                    (MATCH_w_16_0 >> 4 & 0x3) /* adrb at 0 */ == 0 &&
                    (0 <= (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ < 7) ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
                    (MATCH_w_16_0 >> 4 & 0x3) /* adrb at 0 */ == 0 && (MATCH_w_16_0 >> 9 & 0x7) /* reg1 at 0 */ == 7 &&
                    (MATCH_w_16_0 >> 8 & 0x1) /* sb at 0 */ == 1 ||
                (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
                    (1 <= (MATCH_w_16_0 >> 4 & 0x3) /* adrb at 0 */ && (MATCH_w_16_0 >> 4 & 0x3) /* adrb at 0 */ < 4))
...
#line 204 "machine/mc68k/mc68k.pat.m"
        ...
        {
            MATCH_w_16_0 = getWord(MATCH_p);
            if (0 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 3 ||
                4 <= (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ && (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ < 8 ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 3 &&
                    (0 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 4 ||
                     5 <= (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ < 16) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 3 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    ((MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 0 ||
                     2 <= (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ && (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ < 4) ||
                (MATCH_w_16_0 >> 3 & 0x7) /* adrm at 0 */ == 3 && (MATCH_w_16_0 >> 12 & 0xf) /* op at 0 */ == 4 &&
                    (MATCH_w_16_0 >> 6 & 0x3) /* sz at 0 */ == 1 &&
...
Logue *InstructionPatterns::pea_add_rts(CSR &csr, ADDRESS &lc, int &d32) {
    ADDRESS __save = lc;
    int __loc0;
    if (peaPcDisp(lc, __loc0 = 4, VAL) && addil$daIndirect(lc, d32, VAR, SP, VAL) && rts(lc)) {
        vector<int> params(1);
        params[0] = d32;
        if (__save == lc)
            return nullptr;
...
Logue *InstructionPatterns::pea_pea_add_rts(CSR &csr, ADDRESS &lc, int &d32) {
    ADDRESS __save = lc;
    int __loc0;
    if (peaPcDisp(lc, __loc0 = 14, VAL) && peaPcDisp(lc, __loc0 = 4, VAL) && addil$daIndirect(lc, d32, VAR, SP, VAL) &&
        rts(lc)) {
        vector<int> params(1);
        params[0] = d32;
        if (__save == lc)
...
Logue *InstructionPatterns::trap_syscall(CSR &csr, ADDRESS &lc, int &d16) {
    ADDRESS __save = lc;
    int __loc0;
    if (trap(lc, __loc0 = 15, VAL) && Aline(lc, d16, VAR)) {
        vector<int> params(1);
        params[0] = d16;
        if (__save == lc)
            return nullptr;
...
Logue *InstructionPatterns::link_save(CSR &csr, ADDRESS &lc, int &locals, int &d16) {
    ADDRESS __save = lc;
    if (link(lc, FP, VAL, locals, VAR) && moverml$daPreDec(lc, d16, VAR, SP, VAL)) {
        vector<int> params(2);
        params[0] = locals;
        params[1] = d16;
        if (__save == lc)
...
Logue *InstructionPatterns::link_save1(CSR &csr, ADDRESS &lc, int &locals, int &reg) {
    ADDRESS __save = lc;
    if (link(lc, FP, VAL, locals, VAR) && pushreg(lc, reg, VAR)) {
        vector<int> params(2);
        params[0] = locals;
        params[1] = reg;
        if (__save == lc)
...
Logue *InstructionPatterns::push_lea(CSR &csr, ADDRESS &lc, int &locals, int &reg) {
    ADDRESS __save = lc;
    if (pushreg(lc, reg, VAR) && leaSpSp(lc, locals, VAR)) {
        vector<int> params(2);
        params[0] = locals;
        params[1] = reg;
        if (__save == lc)
...
Logue *InstructionPatterns::rest_ret(CSR &csr, ADDRESS &lc, int &d16) {
    ADDRESS __save = lc;
    if (movemrl$daPostInc(lc, SP, VAL, d16, VAR) && unlk(lc, FP, VAL) && rts(lc)) {
        vector<int> params(1);
        params[0] = d16;
        if (__save == lc)
            return nullptr;
...
Logue *InstructionPatterns::rest1_ret(CSR &csr, ADDRESS &lc, int &reg) {
    ADDRESS __save = lc;
    if (popreg(lc, reg, VAR) && unlk(lc, FP, VAL) && rts(lc)) {
        vector<int> params(1);
        params[0] = reg;
        if (__save == lc)
            return nullptr;
...
Logue *InstructionPatterns::clear_stack(CSR &csr, ADDRESS &lc, int &n) {
    ADDRESS __save = lc;
    if ((leaSpSp(lc, n, VAR) || addaw_d16(lc, n, VAR))) {
        vector<int> params(1);
        params[0] = n;
        if (__save == lc)
            return nullptr;
