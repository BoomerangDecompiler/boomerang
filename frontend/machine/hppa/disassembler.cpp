...
void NJMCDecoder::dis_c_c(ADDRESS hostpc) {
    ...
    /*   static char *logdw[] =  {"",",*=",",*< ",",*OD"
                                ,",*TR",",*!=",",*>=",",*EV"}; */
    static char *cmpsubw[] = {"",    ",=",  ",<",  ",<=", ",<<",  ",<<=", ",SV",  ",OD",
                              ",TR", ",<>", ",>=", ",>",  ",>>=", ",>>",  ",NSV", ",EV"};
    static char *cmpsubdw[] = {"",     ",*=",  ",*<",  ",*<=", ",*<<",  ",*<<=", ",*SV",  ",*OD",
                               ",*TR", ",*<>", ",*>=", ",*>",  ",*>>=", ",*>>",  ",*NSV", ",*EV"};
    /*  static char *bitw[]  = {",<", ",>="};*/
    /*  static char *bitdw[] = {",*<", ",*>="};*/
...
#line 372 "machine/hppa/disassembler.m"
        ...
        static char *MATCH_name_p_20_98[] = {
            "VSHD", "SHD",
        };
        static char *MATCH_name_se_21_99[] = {
            "VEXTRU", "VEXTRS",
        };
        static char *MATCH_name_se_21_100[] = {
            "EXTRU", "EXTRS",
        };
        static char *MATCH_name_se_21_101[] = {
            "ZVDEP", "VDEP",
        };
        static char *MATCH_name_se_21_102[] = {
            "ZDEP", "DEP",
        };
        static char *MATCH_name_se_21_103[] = {
            "ZVDEPI", "VDEPI",
        };
        static char *MATCH_name_se_21_104[] = {
            "ZDEPI", "DEPI",
        };
        unsigned MATCH_w_32_0;
        {
...
#line 579 "machine/hppa/disassembler.m"
                            {
                                ...
                                astr +=
                                    sprintf(astr, "(%s,%s),%s", s2_16_names[s2_16], b_06_names[b_06], t_27_names[t_27]);
                ...
                case 3:
                    ...
                    case 2:
                        if ((MATCH_w_32_0 >> 8 & 0x1) /* x_23 at 0 */ == 1) {
                            unsigned r1 = ((MATCH_w_32_0 >> 7 & 0x1) /* r1_24 at 0 */ << 5) +
                                          (MATCH_w_32_0 >> 21 & 0x1f) /* r_06 at 0 */;
                            unsigned r2 = ((MATCH_w_32_0 >> 12 & 0x1) /* f_19 at 0 */ << 5) +
...
#line 653 "machine/hppa/disassembler.m"
    ...
    MATCH_label_a12:
        (void)0; /*placeholder for label*/
        {
            ...
            unsigned r2 =
                ((MATCH_w_32_0 >> 12 & 0x1) /* f_19 at 0 */ << 5) + (MATCH_w_32_0 >> 16 & 0x1f) /* r_11 at 0 */;
            unsigned t = ((MATCH_w_32_0 >> 6 & 0x1) /* t_25 at 0 */ << 5) + (MATCH_w_32_0 & 0x1f) /* t_27 at 0 */;
...
/*
                ...
                | LDWl(cmplt, ldisp, s2_16, b_06, t_11)[name] => {
                        ...
                        c_disps(cmplt);
                        astr += sprintf(astr, "  %d(%s,%s),%s", ldisp, s2_16_names[s2_16], b_06_names[b_06],
   t_11_names[t_11]);
