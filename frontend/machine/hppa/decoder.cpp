...
#include "boomeranghppa.pat.h"   // generated from `sparc.pat'
#include "boomeranghppa-names.h" // generated by 'tools -fieldnames' - has
...
SemStr *NJMCDecoder::dis_c_wcr(unsigned hostPC) { return 0; }

SemStr *NJMCDecoder::dis_ct(unsigned hostPC) { return 0; }
