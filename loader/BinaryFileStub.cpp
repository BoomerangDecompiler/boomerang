...
MACHINE BinaryFileStub::GetMachine() const { return MACHINE_PENTIUM; }

bool BinaryFileStub::isLibrary() const { return false; }
...
ADDRESS BinaryFileStub::getImageBase() { return 0; }

size_t BinaryFileStub::getImageSize() { return 0; }

ADDRESS BinaryFileStub::GetFirstHeaderAddress() { return 0; }

ADDRESS *BinaryFileStub::GetImportStubs(int &numImports) { return nullptr; }

bool BinaryFileStub::DisplayDetails(const char *fileName, FILE *f) { return false; }

std::list<SectionInfo *> &BinaryFileStub::GetEntryPoints(const char *pEntry) { return *new std::list<SectionInfo *>; }

ADDRESS BinaryFileStub::GetMainEntryPoint() { return 0x8048918; }

ADDRESS BinaryFileStub::GetEntryPoint() { return 0; }

std::map<ADDRESS, const char *> *BinaryFileStub::GetDynamicGlobalMap() { return new std::map<ADDRESS, const char *>; }

char *BinaryFileStub::GetStrPtr(int idx, int offset) { return nullptr; }

void BinaryFileStub::SetLinkAndInfo(int idx, int link, int info) { assert(false); }

bool BinaryFileStub::RealLoad(const char *sName) { return false; }

bool BinaryFileStub::PostLoad(void *handle) { return false; }
