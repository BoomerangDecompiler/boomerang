...
extern void YY_TransformationScanner_RESTART YY_PROTO(( FILE *input_file ));
...
extern YY_BUFFER_STATE YY_TransformationScanner_CREATE_BUFFER YY_PROTO(( FILE *file, int size ));
extern void YY_TransformationScanner_DELETE_BUFFER YY_PROTO(( YY_BUFFER_STATE b ));
extern void YY_TransformationScanner_INIT_BUFFER YY_PROTO(( YY_BUFFER_STATE b, FILE *file ));
...
extern FILE *YY_TransformationScanner_IN, *YY_TransformationScanner_OUT;
...
#define YY_TransformationScanner_FATAL_ERROR_CODE fputs( msg, stderr );putc( '\n', stderr );exit( 1 );
#endif
...
class YY_TransformationScanner_CLASS YY_TransformationScanner_INHERIT
{
 ...
 FILE *YY_TransformationScanner_IN, *YY_TransformationScanner_OUT;
